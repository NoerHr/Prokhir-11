        ...
        <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                <div className="bg-white p-6 rounded-xl shadow">
                    ...
                    <p className="text-4xl font-bold text-gray-800">{summaryData.ditemukan}</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow">
                    <h3 className="text-gray-500 text-lg">Barang Diambil</h3>
                    <p className="text-4xl font-bold text-gray-800">{summaryData.diambil}</p>
                </div>
            </div>
                ...
                <table className="w-full text-left">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="p-4 text-gray-600 font-semibold">Tanggal Ditemukan</th>
                    ...
                    <tbody>
                        {foundItemsList.length > 0 ? foundItemsList.map((item, index) => (
                            <tr key={item.id} className={index !== foundItemsList.length - 1 ? "border-b border-gray-200" : ""}>
                                ...
                                <td className="p-4 text-gray-600">{formatDateTime(item.foundDate)}</td>
                                <td className="p-4">
