...
export const DetailBarang: React.FC<DetailBarangProps> = ({ item, onClaim, onDelete }) => {
    ...
    if (!item) {
        return (
            <div className="p-8">
                ...
                <button onClick={() => navigate('/daftar')} className="text-blue-600 hover:underline mt-4">Kembali ke Daftar Barang</button>
            </div>
        );
    }
    ...
    return (
        <div className="p-8">
            <div className="flex justify-between items-center mb-6">
                <div><span className="text-blue-600 cursor-pointer hover:underline" onClick={() => navigate('/daftar')}>Daftar Barang</span><span className="mx-2 text-gray-400">/</span><span className="text-gray-600">Detail</span></div>
